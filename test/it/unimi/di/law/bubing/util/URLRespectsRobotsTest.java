...
public class URLRespectsRobotsTest {
	...
	public void testEmptyString() {
		char[][] robots = URLRespectsRobots.toSortedPrefixFreeCharArrays( new ObjectOpenHashSet<String>( new String[] { "/", "" } ) );
	...
	public void testPrefixesDeep() {
		Set<String> inset = new ObjectOpenHashSet<String>();
		Set<String> pfset = new ObjectOpenHashSet<String>();
