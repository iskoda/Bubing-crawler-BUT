...
public class ByteArrayDiskQueues implements Closeable, Size64 {
	...
	public ByteArrayDiskQueues( final File dir, final int log2LogFileSize ) {
		...
		key2QueueData = new Reference2ObjectOpenHashMap<Object, ByteArrayDiskQueues.QueueData>();
		files = new ObjectArrayList<RandomAccessFile>();
		buffers = new ObjectArrayList<ByteBuffer>();
	}
