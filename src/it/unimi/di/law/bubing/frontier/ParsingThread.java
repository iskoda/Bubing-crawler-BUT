...
public class ParsingThread extends Thread {
	...
	protected static final Object2LongOpenHashMap<Class<?>> EXCEPTION_TO_WAIT_TIME = new Object2LongOpenHashMap<Class<?>>();
	/** A map recording for each type of exception the number of retries. */
	protected static final Object2IntOpenHashMap<Class<?>> EXCEPTION_TO_MAX_RETRIES = new Object2IntOpenHashMap<Class<?>>();
	/** A map recording for each type of exception the number of retries. */
	protected static final ObjectOpenHashSet<Class<?>> EXCEPTION_HOST_KILLER = new ObjectOpenHashSet<Class<?>>();
